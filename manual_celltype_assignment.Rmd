...
Idents(cluster_5) = "sub.cluster"
cluster_5_markers = FindAllMarkers(cluster_5, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
write_tsv(cluster_5_markers, "tables/markers/cluster_5_markers.tsv")
...
future(saveRDS(seurat_df_harmony_keep_0_75_no_doublets, "rds_objects/seurat_df_harmony_keep_0_75_no_doublets.rds"))
```

```{r}
seurat_df_harmony_keep_0_75_no_doublets
