...
# Lane 7079-3 had an overabundance of doublets, so setting doublet filter higher for that lane.
```{r}
...
# Save files in 10X format (followed explanation here: https://www.biomage.net/blog/how-to-demultiplex-a-seurat-object-and-convert-it-to-10x-files).
```{r}
...
# Split and save by CHIP/control status.
```{r}
...
# Split and save by TET2/SRSF2 and TET2 status.
```{r}
diet_seurat_trimmed = readRDS("rds_objects/diet_seurat_trimmed.rds")
